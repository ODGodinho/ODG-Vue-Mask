...
// CONCATENATED MODULE: ./node_modules/@odg/odg-mask/src/helper.js
...
// CONCATENATED MODULE: ./node_modules/@odg/odg-mask/src/tokens.js
...
// CONCATENATED MODULE: ./node_modules/@odg/odg-mask/src/ODGMask.js
...
/* harmony default export */ var src_ODGMask = __webpack_exports__["a"] = (ODGMask);
...
/* harmony import */ var _ODGMask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
(() => {
  ...
  document.addEventListener(
    ...
    (event) => {
      ...
      const nValue = Object(_ODGMask__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(
        el.value,
        mask,
        {
          el: el,
...
// EXTERNAL MODULE: ./node_modules/@odg/odg-mask/src/ODGMask.js + 2 modules
var ODGMask = __webpack_require__(0);

// CONCATENATED MODULE: ./node_modules/@odg/odg-mask/src/index.js


__webpack_require__(3);

/* harmony default export */ var src = (ODGMask["a" /* default */]);
...
const updateMaskDirective = function (el, direc, vNodeNew) {
  ...
  const mask = src(String(currentValue), direc.value, { el: el });
  let changed = false;
...
const updateMaskInputEvent = function (el, direc, vNodeNew) {
  ...
  const mask = src(currentValue, direc.value, { el: el });

  if (!mask) return;
  if (currentValue === String(mask.value)) return;
...
/* harmony default export */ var directive = ({
  ...
  update: function (el, direc, vNodeNew) {
    if(el.tagName === 'DIV') console.log(direc, vNodeNew);
    updateMaskDirective(el, direc, vNodeNew);
  },
});
...
/* harmony default export */ var src_0 = __webpack_exports__["default"] = (ODGVueMask);
